...
Public Interface IModelBuilder
    Function GetModel(ByVal filename As String) As IModel
    Function GetModel(ByVal input As TextReader) As IModel
    Function GetModel(ByVal node As XmlNode) As IModel
End Interface
