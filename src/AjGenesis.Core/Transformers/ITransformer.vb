...
Public Interface ITransformer
    Sub Transform(ByVal input As TextReader, ByVal output As TextWriter, ByVal env As Environment)
    Sub Transform(ByVal inputfile As String, ByVal outputfile As String, ByVal env As Environment)
End Interface
