<%@ Page Language="VB" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="false" CodeFile="BuildList.aspx.vb" Inherits="BuildList" title="Builds" Theme="Default" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:HyperLink ID="lnkHelp" runat="server" NavigateUrl="~/PageView.aspx?Page=BuildListPageHelp" Text="Help" Target="_blank"/>&nbsp;&nbsp;&nbsp;
    </div>
    <br />
    <br />
