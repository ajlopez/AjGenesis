...
Partial Class ProjectList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            DirectoryName = DirectoryService.GetProjectsDirectory
            Directory1.Path = DirectoryName
        End If
    End Sub

    Protected Sub lnkNewProject_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNewProject.Click
        Server.Transfer("~/ProjectNew.aspx")
    End Sub
