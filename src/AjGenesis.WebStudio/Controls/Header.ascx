<%@ Control Language="vb" AutoEventWireup="false" CodeFile="Header.ascx.vb" Inherits="Controls_Header" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table id=TableMenuTop cellSpacing="0" cellPadding="0" width="100%" border="0" height=15>
	<tr>
		...
		<td width="140" class="MainMenu"><a href='~/Help.aspx' runat="server" ID="A2">Help Index</a></td>
		<td width="140" class="MainMenu"><a href='http://www.ajlopez.com/ajgenesis' runat="server" ID="A4">AjGenesis</a></td>
