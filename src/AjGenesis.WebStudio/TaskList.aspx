<%@ Page Language="VB" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="false" CodeFile="TaskList.aspx.vb" Inherits="TaskList" title="Tasks" Theme="Default" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:HyperLink ID="lnkHelp" runat="server" NavigateUrl="~/PageView.aspx?Page=TaskListPageHelp" Text="Help" Target="_blank"/>&nbsp;&nbsp;&nbsp;
    </div>
    <br />
    <br />
