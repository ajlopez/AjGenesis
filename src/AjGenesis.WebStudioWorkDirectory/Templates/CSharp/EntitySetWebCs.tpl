...
<%@ Page Language="c#" AutoEventWireup="false" Codebehind="${Entity.SetName}.aspx.cs" Inherits="${Project.Name}.WebClient.${Entity.SetName}Page"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
			...
			<br>
			<asp:DataGrid id="dtgData" runat="server" CssClass="DataTable" AutoGenerateColumns="False" Width="80%">
				<Columns>
