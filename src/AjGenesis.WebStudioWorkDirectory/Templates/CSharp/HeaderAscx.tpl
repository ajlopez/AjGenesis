<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Header.ascx.cs" Inherits="${Project.Name}.WebClient.Controls.Header" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
