...
#>
				<tr>
					...
					<td>
						<asp:HyperLink id='hln${Property.Name}' runat='server' NavigateUrl='<%# "${Property.Reference.Name}.aspx?Id=" & Entity.${Property.Reference.Name}.${Property.Reference.IdProperty.Name} %>'>
							<%# Entity.${Property.Reference.Name}.${Property.Reference.DescriptorProperty.Name} %>
						</asp:HyperLink>
</td>
				</tr>
<#
...
#>
                    ...
                    <asp:TemplateField HeaderText="${Property.Description}">
                        <ItemTemplate>
						<asp:HyperLink id='hln${Property.Reference.Name}' runat='server' NavigateUrl='<%# "${Property.Reference.Name}.aspx?Id=" & DirectCast(Container.DataItem,${Project.Name}.Domain.${Relation.Entity.Name}).${Property.Reference.Name}.${Property.Reference.IdProperty.Name} %>'>
							<asp:Label id='lbl${Property.Reference.Name}' runat='server' text='<%# DirectCast(Container.DataItem,${Project.Name}.Domain.${Relation.Entity.Name}).${Property.Reference.Name}.${Property.Reference.DescriptorProperty.Name} %>'></asp:Label>
						</asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
<#
