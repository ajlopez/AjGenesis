...
&nbsp;&nbsp;<strong></strong>&nbsp;&nbsp;<a target='_top' href='<%=prefix%>index.jsp' class='menuoption'>Main</a><br>
</td>
</tr>
</table>
...
#>
&nbsp;&nbsp;<strong></strong>&nbsp;&nbsp;<a target='_top' href='<%=prefix%>${Entity.Name}List.jsp' class='menuoption'>${Entity.SetDescriptor}</a><br>
<#
	end for
#>
</td>
