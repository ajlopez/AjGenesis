...
<hibernate-mapping>
	...
	<class name="${Project.PackageName}.domain.entities.${Entity.Name}" table="${Technology.Database.Prefix}${Entity.SqlTable}">
<#
...
#>
		<bag name="${Relation.Entity.SetName}" lazy="true" inverse="true" cascade="all">
			...
			<one-to-many class="${Project.PackageName}.domain.entities.${Relation.Entity.Name}"/>
		</bag>	
<#
	end for
#>
