...
Public Class Repository
    Private Shared mRepository As Repository

    Private mSessionFactory As SessionFactory
    Private mActiveSession As ISession

    Public Sub New()
        mSessionFactory = SessionFactory.Instance
    End Sub

    Public Shared ReadOnly Property Current() As Repository
        Get
            If Not System.Web.HttpContext.Current Is Nothing Then
                If System.Web.HttpContext.Current.Items("NHRepository") Is Nothing Then
                    System.Web.HttpContext.Current.Items("NHRepository") = New Repository
                End If
                Return DirectCast(System.Web.HttpContext.Current.Items("NHRepository"), Repository)
            End If
